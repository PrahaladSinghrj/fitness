                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-10">
                            <div class="hero__caption">
                                ...
                                <a href="courses.aspx" class="border-btn hero-btn" data-animation="fadeInLeft" data-delay="0.8s">My Courses</a>
                            </div>
                        </div>
                    </div>
                </div>          
                        ...
                        <div class="topic-img">
                            ...
                            <div class="topic-content-box">
                                <div class="topic-content">
                                    ...
                                    <a href="courses.aspx" class="border-btn">View Courses</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="topic-img">
                            ...
                            <div class="topic-content-box">
                                <div class="topic-content">
                                    <h3>Group traning</h3>
                                    <p>You’ll look at graphs and charts in Task One, how to approach the task and <br> the language needed for a successful answer.</p>
                                    <a href="courses.aspx" class="btn">View Courses</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box snake mb-30">
                        ...
                        <div class="overlay">
                            <div class="overlay-content">
                                ...
                                <a href="gallery.aspx"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="properties mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <p class="mb-25">₹4000/m  <span>(Single class)</span></p>
                                ...
                                <a href="payment.aspx" class="border-btn border-btn2">Join Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="properties mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">6 month</span>
                                <p class="mb-25">₹2000/m  <span>(Single class)</span></p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="properties mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">6 month</span>
                                <p class="mb-25">₹3000/m  <span>(Single class)</span></p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
            ...
            <div class="left-content2">
                ...
                <div class="section-tittle2 mb-20 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                    <div class="front-text">
                        ...
                        <a href="courses.aspx" class="border-btn">My Courses</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                    <div class="single-services mb-40 wow fadeInUp" data-wow-duration="2s" data-wow-delay=".4s">
                        ...
                        <div class="features-caption">
                            <h3>Email</h3>
                            <p>gymmaster@gmail.com</p>
                            <p>psrajawat9928157841@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="single-footer-caption mb-50 text-center">
                            ...
                            <div class="footer-logo wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                                <a href="Default.aspx"><img src="assets/img/logo/logo2_footer.png" alt=""></a>
                            </div>
                            <!-- Menu -->
                            <!-- Header Start -->
                    ...
                    <div class="col-lg-12">
                        <div class="footer-copy-right text-center">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                             Thanks &copy;<script>document.write(new Date().getFullYear());</script> Thank you my team <i class="fa fa-heart" aria-hidden="true"></i> by <a href="Default.aspx" target="_blank">Gym Master</a>
