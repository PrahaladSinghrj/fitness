                ...
                <div class="row d-flex align-items-center">
                    <div class="col-lg-12">
                        <div class="footer-copy-right text-center">
                            ...
                            Thanks &copy;<script>document.write(new Date().getFullYear());</script> Thank you my team <i class="fa fa-heart" aria-hidden="true"></i> by <a href="Default.aspx" target="_blank">Gym Master</a>  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                          </div>
                      </div>
                  </div>
              </div>
